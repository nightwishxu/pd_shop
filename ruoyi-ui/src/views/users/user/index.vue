<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="用户账号(手机号)" prop="account">
        <el-input
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户账号(手机号)" align="center" prop="account" />
      ...
      <el-table-column label="完善资料" align="center" prop="isComplete"  :formatter="isCompleteFormat"/>
       <el-table-column label="状态" align="center" prop="state">
          <template slot-scope="scope">
            <el-button size="mini" type="danger" plain v-if = "scope.row.state" @click = "handleForbid(scope.row)">禁用</el-button>
            <el-button size="mini" type="primary" plain v-else @click = "handleForbid(scope.row)">启用</el-button>
          </template>
       </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="完善资料" prop="isComplete">
