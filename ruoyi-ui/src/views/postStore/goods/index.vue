<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类别" align="center" prop="pawnName" />
      <el-table-column label="名称" align="center" prop="name" />
      <el-table-column label="组图" align="center" prop="imgs">
        <template scope="scope">
          <span v-for="(item,index) in scope.row.sellImgs.split(',')" :key="index">
      ...
      <el-table-column label="上架时间" align="center" prop="sellStartTime" />
      <el-table-column label="状态" align="center" prop="sellStatus" :formatter="handleSellStatus" />
      ...
      <el-table-column label="订单状态" align="center" prop="orderState" :formatter="handleOrderState" />
      <el-table-column
        label="结算状态"
        align="center"
        prop="settleStatus"
    ...
    <el-dialog :title="title1" :visible.sync="open1" width="400px" append-to-body>
      <el-form ref="form1" :model="form1" label-width="150px">
        <el-form-item label="结算金额" prop="settleMoney" id="refuseInfo">
          <el-input v-model="form1.settleMoney" placeholder="请输结算金额" />
        </el-form-item>
        <el-form-item label="原因" prop="sellRemark" id="refuseInfo">
          <el-input v-model="form1.sellRemark" placeholder="请输入原因" />
        </el-form-item>
      </el-form>
    ...
    >
      <el-form ref="form" :model="form" label-width="150px">
        <el-form-item label="上传的寄卖图片" prop="sellImgs">
          ...
          <template scope="scope">
            <span v-for="(item,index) in form.sellImgs.split(',')" :key="index">
              <el-popover placement="left" trigger="click" width="300">
                <el-image :src="item" />
                <el-image
                  slot="reference"
        ...
        <el-form-item label="邮寄鉴定结果" prop="authResult">
          <el-input v-model="form.authResult" style="color:red" disabled></el-input>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
