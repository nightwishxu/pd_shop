<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="优惠金额" align="center" prop="full" />
      <el-table-column label="领取后有效天数" align="center" prop="days" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="优惠金额" prop="full">
          <el-input v-model="form.full" placeholder="请输入优惠金额" />
        </el-form-item>

        <el-form-item label="领取后有效天数" prop="days">
          <el-input v-model="form.days" placeholder="请输入领取后有效天数" />
        </el-form-item>
      </el-form>
