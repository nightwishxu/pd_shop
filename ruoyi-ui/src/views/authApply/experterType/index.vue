<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['experterType:domain:add']"
          >新增</el-button
        >
      </el-col>
    ...
    >
      ...
      <el-table-column label="领域名称" align="center" prop="domainName" />
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有专业领域技能数据项?", "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      })
