<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['community:article:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['community:article:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['community:article:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['community:article:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="公告描述" align="center" prop="id" />
      <el-table-column label="用户编号" align="center" prop="userId" />
      <el-table-column label="封面" align="center" prop="cover" />
      <el-table-column label="类型默认1用户帖子 2后台帖子" align="center" prop="type" />
      <el-table-column label="0删除1草稿2发布" align="center" prop="status" />
      <el-table-column label="0隐藏1展示" align="center" prop="isShow" />
      ...
      <el-table-column label="点赞数" align="center" prop="praiseCount" />
      <el-table-column label="点击数" align="center" prop="clickCount" />
      <el-table-column label="举报数" align="center" prop="reportCount" />
      ...
      <el-table-column label="发布时间" align="center" prop="createName" />
      <el-table-column label="发布时间" align="center" prop="updateName" />
      <el-table-column label="排序" align="center" prop="sort" />
      <el-table-column label="公告描述" align="center" prop="description" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="类型默认1用户帖子 2后台帖子">
          <el-select v-model="form.type" placeholder="请选择类型默认1用户帖子 2后台帖子">
        ...
        <el-form-item label="0隐藏1展示" prop="isShow">
          <el-input v-model="form.isShow" placeholder="请输入0隐藏1展示" />
        </el-form-item>
        <el-form-item label="标题" prop="title">
