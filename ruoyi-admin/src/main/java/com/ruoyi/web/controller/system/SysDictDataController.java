...
public class SysDictDataController extends BaseController
{
    ...
    @GetMapping("/export")
    public Ret export(SysDictData dictData)
    {
        List<SysDictData> list = dictDataService.selectDictDataList(dictData);
    ...
    {
        return Ret.success(dictTypeService.selectDictDataByType(dictType));
    }
    ...
    @PutMapping
    public Ret edit(@Validated @RequestBody SysDictData dict)
    {
    ...
    public Ret remove(@PathVariable Long[] dictCodes)
    {
