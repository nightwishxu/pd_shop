...
public class HttpClient {
    ...
    public int send(HttpURLConnection connection, String requestData, File file, String signature) throws IOException {
        if (requestData != null) {
            ...
            outputStream.write(CommonUtil.getBytes(requestDataString));
